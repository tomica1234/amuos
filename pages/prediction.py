...
if st.session_state['name'] == 'このカーナンバーは申請されていません。公式SNSのDMにて参加申請をしてください。':
    ...
    original_items_q = [
        {'header': '予選順位：', 'items':['フェルスタッペン', 'ペレス', 'ハミルトン', 'ラッセル', 'ルクレール', 'サインツ', 'ノリス', 'ピアストリ', 'アロンソ','ストロール','ガスリー','オコン','アルボン','コラピント','角田','リカルド','ボッタス','周','ヒュルケンベルグ','マグヌッセン']},
    ]
    sorted_items_q = sort_items(original_items_q, multi_containers=True, direction='vertical')

    original_items_r = [
        {'header': '決勝順位：', 'items':['フェルスタッペン', 'ペレス', 'ハミルトン', 'ラッセル', 'ルクレール', 'サインツ', 'ノリス', 'ピアストリ', 'アロンソ','ストロール','ガスリー','オコン','アルボン','コラピント','角田','リカルド','ボッタス','周','ヒュルケンベルグ','マグヌッセン']},
        {'header': '決勝リタイア：',
            'items': []}
    ]
    ...
    driver_number = {'フェルスタッペン':1, 'ペレス':11, 'ハミルトン':44, 'ラッセル':63, 'ルクレール':16, 'サインツ':55, 'ノリス':4, 'ピアストリ':81, 'アロンソ':14,'ストロール':18,'ガスリー':10,'オコン':31,'アルボン':23,'コラピント':2,'角田':22,'リカルド':3,'ボッタス':77,'周':24,'ヒュルケンベルグ':27,'マグヌッセン':20}
